  ...
  return (
    <div>
      ...
      <div className="flex gap-4 my-8">
        {/* Total Bookings */}
        <div className="bg-black/3 border border-black/10 rounded flex p-4 pr-8">
          <img
          ...
          <div className="flex flex-col sm:ml-4 font-medium">
            <p className="text-black text-lg">Total Bookings</p>
        ...
        <div className="bg-black/3 border border-black/10 rounded flex p-4 pr-8">
          ...
          />
          <div className="flex flex-col sm:ml-4 font-medium">
            <p className="text-black text-lg">Total Revenue</p>
            <p className="text-neutral-400 text-base">
